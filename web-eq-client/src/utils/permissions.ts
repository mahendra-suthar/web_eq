...
export const ROLE_PERMISSIONS: Record<PermissionKey, ProfileType[]> = {
  ...
  [Permission.VIEW_LEAVE]: [ProfileType.BUSINESS, ProfileType.EMPLOYEE],
...
export const ROUTE_PERMISSION: Record<string, PermissionKey> = {
  ...
  [ROUTERS_PATH.LEAVE]: Permission.VIEW_LEAVE,
...
export const NAV_ITEMS: NavItemConfig[] = [
  ...
  { path: ROUTERS_PATH.LEAVE, label: "Leave", icon: "🌴", permission: Permission.VIEW_LEAVE, sectionTitle: "Employee Management" },
